...
private:
	...
	Vector<Block*> *bvv;
	Vector<M_Gumba*> *mushv;

public:
	bool del;
	bool burn;

	void m_init(Vec2 Pos, Layer * layer,  Vector<Block*> *v, Vector<M_Gumba*> *mv);
	...
	static M_Gumba * m_create(Vec2 Pos, Layer * layer, Vector<Block*> *v, Vector<M_Gumba*> *mv)
	{
		auto ref = new M_Gumba();
